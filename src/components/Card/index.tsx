...
export const CustomCard: React.FC<CustomCardProps> = ({ title = "Title", link = "#", content = "Content" }) => {
    return (
        <LargeCard
            title={title}
            extra={true}
            extraHTML={<Link href={link} className='hover:text-black'><Icon.ArrowUpRight size={18} className="font-semibold bg-transparent" /></Link>}
            content={
