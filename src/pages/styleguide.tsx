  ...
  return (
    <>
      ...
      <div className="container">
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-6">Style Guide</h1>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4">Layout and Spacing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4">Forms and Inputs</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4">Code Blocks</h2>
